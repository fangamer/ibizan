...
{ CONTEXTS, HEADERS, STRINGS, TIMEZONE } = require '../helpers/constants'
...
module.exports =
  init: (controller) ->
    ...
    controller.hears 'uptime', CONTEXTS, (bot, msg) ->
      bot.startTyping msg
      bot.reply msg, "#{Organization.name}'s Ibizan has been up since
